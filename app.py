...
with st.form("user_form"):
    ...
    male_cancer_symptoms = [
        "स्तन में गांठ / मोटापन", "असामान्य निप्पल स्राव", "पेट दर्द / सूजन",
        "प्रोस्टेट की समस्या", "वृषण में गांठ / सूजन", "असामान्य रक्तस्राव / चोट के निशान",
        "लगातार दर्द", "मुंह में छाले / खून / सुन्नपन", "लगातार खांसी / आवाज़ में बदलाव",
    ...
    female_cancer_symptoms = [
        ...
        "असामान्य योनि रक्तस्राव", "पेट दर्द / सूजन", "लगातार दर्द", 
    ...
    male_cancer_selection = st.multiselect(
        "पुरुष कैंसर लक्षण",
        male_cancer_symptoms,
        key="male_cancer_select",
        disabled=(gender != "पुरुष")
    )

    female_cancer_selection = st.multiselect(
        "महिला कैंसर लक्षण",
        female_cancer_symptoms,
        key="female_cancer_select",
        disabled=(gender != "महिला")
    )

    selected_cancer = male_cancer_selection if gender == "पुरुष" else female_cancer_selection
